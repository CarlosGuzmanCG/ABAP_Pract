class ZCL_PEDIDO_AREA_ALFA02 definition
  public
...
public section.
  ...
  constants AREA_NAME type SHM_AREA_NAME value 'ZCL_PEDIDO_AREA_ALFA02' ##NO_TEXT.
  data ROOT type ref to ZCL_PEDIDO_ALFA02 read-only .
  ...
  class-methods ATTACH_FOR_READ
    ...
    returning
      value(HANDLE) type ref to ZCL_PEDIDO_AREA_ALFA02
    raising
      CX_SHM_INCONSISTENT
  ...
  methods SET_ROOT
    importing
      !ROOT type ref to ZCL_PEDIDO_ALFA02
    raising
...
CLASS ZCL_PEDIDO_AREA_ALFA02 IMPLEMENTATION.
