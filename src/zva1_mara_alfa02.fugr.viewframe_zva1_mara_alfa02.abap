*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZVA1_MARA_ALFA02
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZVA1_MARA_ALFA02    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZVA1_MARA_ALFA02'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZVA1_MARA_ALFA02_EXTRACT
TOTAL = ZVA1_MARA_ALFA02_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZVA1_MARA_ALFA02'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZVA1_MARA_ALFA02-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVA1_MARA_ALFA02_EXTRACT
TOTAL = ZVA1_MARA_ALFA02_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZVA1_MARA_ALFA02-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZVA1_MARA_ALFA02'
...
TOTAL = ZVA1_MARA_ALFA02_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZVA1_MARA_ALFA02-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZVA1_MARA_ALFA02-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZVA1_MARA_ALFA02'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZVA1_MARA_ALFA02-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVA1_MARA_ALFA02_EXTRACT
TOTAL = ZVA1_MARA_ALFA02_TOTAL
